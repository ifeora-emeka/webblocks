...
import {
  TbBracketsContain, TbColumns2,
  TbContainer, TbCopy,
  TbEyeClosed,
  TbFrame,
  TbHeading, TbLayout, TbLayoutGrid, TbLayoutList, TbLayoutRows,
  TbLink, TbLock,
  TbPhoto,
  TbPlus,
  TbRectangle, TbSection,
  TbTextSize, TbTrash,
} from 'react-icons/tb'
      ...
      <DropdownMenuContent className="dark bg-card">
        <DropdownMenuSub>
          ...
          <DropdownMenuPortal>
            ...
            >
              <DropdownMenuItem className="gap-default_spacing" onClick={() => addElement('heading')}>
                <TbHeading /> Heading
              </DropdownMenuItem>
              <DropdownMenuItem className="gap-default_spacing">
                <TbTextSize /> Paragraph
              </DropdownMenuItem>
              <DropdownMenuItem className="gap-default_spacing" onClick={() => addElement('frame')}>
                <TbFrame /> Frame
              </DropdownMenuItem>
              <DropdownMenuItem className="gap-default_spacing">
                <TbPhoto /> Image
